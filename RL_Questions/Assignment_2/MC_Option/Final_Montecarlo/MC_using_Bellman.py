...
#Option Trade is OptionsAvailable

#risk_free_rate is guaranteed_win

#time_to_maturity is time_remaining

#WTB_amount is willing to bet

#trade is hand

#pay_off is pay_out

#OptionTradePayoffPricer is OptionHandPayoutCalculator

#discounted_price is price_after_risk_reduction

#def CalculatePrice is def CalculateBASP
...
class BEModel:
    ...
    def BASP_Array(self, hand):
        ...
        for scenarioNumber in range(self.Configuration.NumberOfScenarios):
            ...
            next_hand = (hand.guaranteed_win)-0.5*((1-0.05)**2)

            unpredictability =(1-0.05)*np.sqrt(timestep)*normal_random_number
...
def main():
    ...
    input_amt = float(input("Please enter your current amount: "))

    input_WTB = float(input("Please enter Willing to bet amount: "))

    Task_1_Solution.main()
    ...
    for k,v in best_policy.items():
        ...
        hand = OptionsAvailable(input_amt,input_WTB,v[1], 1)

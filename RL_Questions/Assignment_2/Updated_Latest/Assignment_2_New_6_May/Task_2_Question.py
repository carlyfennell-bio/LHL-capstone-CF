...
#Question: Define Monte Carlo simulation of self, hand and BASP to return betting amount allowed
...
def main():
    ...
    #Question: Fetch the best policy using Monte Carlo simulations using the model from Bellman Equation, calculating the hand from available options and option hand payout calculations.

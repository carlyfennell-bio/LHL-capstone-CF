...
readfile()
#Question: Define the reward, action and transition for the Markov Decision Process and then specify the value iteration reward function so that best policy is derived using that function.
class MDProcess:
